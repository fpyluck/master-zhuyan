...
For filesystem/repository environments, use `references/filesystem-execution.md` for explicit file inspection and deliverable creation protocols.
...
For filesystem execution details, use `references/filesystem-execution.md`. For split strategy selection, use `references/multi-agent-patterns.md`.
...
16. `references/filesystem-execution.md`: use in filesystem/repository environments for file inspection and deliverable creation protocols.
