...
3. Creating role names without artifacts: calling an agent a "researcher" without requiring it to produce Evidence Ledger entries is fake modularity (`references/filesystem-execution.md` section 5).
